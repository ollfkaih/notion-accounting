...
def fetch_data_from_notion(notion: Client, database_id: str, filter_params=None):
    ...
    while has_more:
        # Prepare the query payload, conditionally including 'filter' if provided
        query_payload = {
        ...
        database_data = notion.databases.query(**query_payload)

        # print(str(database_data) + " DATABASE DATA")  # Removed concatenation error
